...
insert into dbo.Product (ProductId,CategoryId,ProductName,ProductDescription,ProductStock,ProductPrice) values ( 4,2,'13inch Laptop','HP laptop,8GB RAM,250GB SSD',45,799.00 );
